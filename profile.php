...
<body id="profile">
  ...
  if (isset($_SESSION['u_id'])) {
    echo '<a href="#userPic"><img class="profile_img" src="uploads/'.$_SESSION['u_uid'].'_profile.'.$fileExt.'" alt="'.$_SESSION['u_first'].' '.$_SESSION['u_last'].' Profile Image"></a>';
  } else {
...
<?php
  ...
  echo '<div class="user-photo"><img class="profile_img" src="uploads/'.$_SESSION['u_uid'].'_profile.jpg" alt="'.$_SESSION['u_first'].' '.$_SESSION['u_last'].' Profile Image"></div>';
  echo '<p class="name">'.$_SESSION['u_first'].' '.$_SESSION['u_last'].'</p>';
  echo '</div>';
?>
          </div>
        </aside>
